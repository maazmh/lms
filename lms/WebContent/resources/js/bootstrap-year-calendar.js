 ...
 (function($) {
	...
	Calendar.prototype = {
		...
		_initializeOptions: function(opt) {
			...
			this.options = {
				startYear: !isNaN(parseInt(opt.startYear)) ? parseInt(opt.startYear) : parseInt(document.getElementById('year').value), //Changed by Maaz from "new Date().getFullYear()" to parseInt() function.
